...
| BE-03 | 用户控制台 API                                    | `be-user-console-api`    | `master-relay` | —                       | done | 已合入 5a0f461          |
| BE-04 | 管理端内容 UI                                     | `be-admin-content-ui`    | `master-relay` | BE-01、BE-02            | done | 已合入 f1b57cb（+2e6448d） |
...
| FE-03 | 登录 / 注册 / 用户中心                            | `fe-auth-account`        | `master-relay` | BE-03、FE-01、FE-02     | todo | worktree 已建，待认领   |
